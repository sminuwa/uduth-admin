    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
            <div class="dash-widget">
                ...
                <div class="dash-widget-info text-right">
                    <h3>{{ get_patients(get_user()->id, date('Y-m-d'))->count()  }}</h3>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
            <div class="dash-widget">
                ...
                <div class="dash-widget-info text-right">
                    <h3>{{ get_patients(get_user()->id, date('Y-m'))->count() }}</h3>
...
{{--                    <h3>{{ count(get_payment_by_user(get_user()->id)) }}</h3>--}}
                    <h3>{{ get_patients(get_user()->id, date('Y'))->count() }}</h3>
    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
            <div class="dash-widget">
                ...
                <div class="dash-widget-info text-right">
                    <h3>&#8358; {{ number_format(get_payment_by_user(get_user()->id, date('Y-m-d'))->sum('service_amount')) }}</h3>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
            <div class="dash-widget">
                ...
                <div class="dash-widget-info text-right">
                    <h3>&#8358; {{ number_format(get_payment_by_user(get_user()->id, date('Y-m'))->sum('service_amount')) }}</h3>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
            <div class="dash-widget">
                ...
                <div class="dash-widget-info text-right">
                    {{--                    <h3>{{ count(get_payment_by_user(get_user()->id)) }}</h3>--}}
                    <h3>&#8358; {{ number_format(get_payment_by_user(get_user()->id, date('Y'))->sum('service_amount')) }}</h3>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                            @foreach(get_payment_by_user(get_user()->id, date('Y-m-d'))->orderBy('id', 'DESC')->get() as $payment)
                                <tr>
            ...
            <div class="card member-panel">
                ...
                <div class="card-body">
                    <ul class="contact-list">
                        @foreach(get_patients(get_user()->id, date('Y-m-d'))->orderBy('id', 'DESC')->get() as $patient)
                            <li>
        ...
        $(document).ready(function(){
            ...
            let patientChart = {
                ...
                datasets: [{
                    ...
                    borderWidth: 1,
                    data: [
                        {{ get_patient_stats_data(get_patient_stats_label('Jan', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Feb', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Mar', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Apr', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Mar', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Jun', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Jul', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Aug', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Sep', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Oct', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Nov', $year))->count() }},
                        {{ get_patient_stats_data(get_patient_stats_label('Dec', $year))->count() }}
                    ]
                }]
            };
            ...
            let revenueChart = {
                ...
                datasets: [{
                    ...
                    borderWidth: 1,
                    data: [
                        {{ get_revenue_stats_data(get_revenue_stats_label('Jan', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Feb', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Mar', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Apr', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Mar', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Jun', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Jul', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Aug', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Sep', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Oct', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Nov', $year))->sum('service_amount') }},
                        {{ get_revenue_stats_data(get_revenue_stats_label('Dec', $year))->sum('service_amount') }}
                    ]
                }]
            };
