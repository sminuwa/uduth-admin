                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="username" id="username" class="form-control" type="text" value="{{ $user->username }}" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="dob" id="dob" type="text" value="{{ $user->dob }}" class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group gender-select">
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input name="gender" type="radio" class="form-check-input" value="Male" @if($user->gender == "Male") checked  @endif required>Male
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input name="gender" type="radio" class="form-check-input" value="Female" @if($user->gender == "Female") checked  @endif required>Female
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="phone" id="phone" class="form-control" type="text" value="{{ $user->phone }}" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
